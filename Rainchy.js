...
try {
		...
		if (isEval && senderNumber == "6281398274790") {
			let evaled,
				text = q,
...
"sellerJid": "6281398274790@s.whatsapp.net",
...
const botzZeltoria = "6281398274790"
...
const seactions = [{
title: `List Menu Rainchy, Silahkan Pilih Salah Satu`,
rows: [
...
break
case 'menu':{
ehe = `Hai Kak @${sender.split("@")[0]} Ogenki Desu Ka?? 
...
"mediaType": 1, 
"thumbnail": ppnyauser,
"mediaUrl": 'https://chat.whatsapp.com/J6SNWsENprgGPtMaMzUH3P',
"sourceUrl": 'https://chat.whatsapp.com/J6SNWsENprgGPtMaMzUH3P'
}
}
})
break
...
break
case 'play':{
if (!text) return reply(`Example : ${prefix+command} Yoasobi Idol`)
reply(mess.wait)
let search = await yts(text)
url = search.videos[0].url
let anu = search.videos[Math.floor(Math.random() * search.videos.length)]
eek = await getBuffer(anu.thumbnail)
owned = '6281398274790@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
case 'jadianime':{
    ...
    try {
        ...
        await Zeltoria.sendMessage(from, { 
            ...
            caption: "Nih Maaf Kalo Hasilnya Jelek >,<" 
        }, { quoted: m } )
    } catch (e) {
